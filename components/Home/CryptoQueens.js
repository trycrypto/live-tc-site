      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center max-w-screen-xl mx-auto py-20 md:py-40 ">
        <div className="w-full max-w-md mx-auto md:max-w-lg md:mx-8">
          <div className="lg:py-8 font-black flex-col justify-center items-center text-center md:text-left">
            <h2 className="mt-2 mx-auto md:mx-0  text-4xl sm:text-5xl lg:text-6xl leading-tight bg-clip-text text-transparent bg-yellow-bkg ">
              {" "}
              CryptoQueens
            </h2>

            <p className="mt-4 text-sm md:text-base leading-relaxed tracking-wider text-grey-extralight font-thin">
              Celebrating the greatest women in Cryptography. Join our discord
              to learn more about whitelisting for our drop.
            </p>
